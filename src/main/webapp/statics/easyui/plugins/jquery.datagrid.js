...
(function ($) {
    ...
    function _77(_78) {
        ...
        _7d.each(function () {
            $(this).resizable({
                handles: _81, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _79.resizing = true;
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        showFooter: false,
        scrollbarSize: 18,
        rowEvents: {mouseover: _87(true), mouseout: _87(false), click: _90, dblclick: _9b, contextmenu: _a0},
        ...
        loader: function (_23f, _240, _241) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _23f, dataType: "json", success: function (data) {
                    _240(data);
                }, error: function () {
