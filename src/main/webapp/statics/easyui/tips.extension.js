...
$.extend($.fn.datagrid.methods, {
    ...
    doCellTip: function (jq, params) {
        function showTip(showParams, td, e, dg) {
            ...
            //显示前执行的方法 by:xsl
            if (showParams.onBefore && typeof showParams.onBefore === 'function') {
                var content = showParams.onBefore(td);
                if (content)
                    showParams.content = content;
            }
...
onBefore(td) function 显示tip前执行的函数 返回一个字符串 （设置此参数后 如果有返回值会替换掉原有的tip内容）
