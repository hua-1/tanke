$.fn.datagrid.emptydataView = $.extend({}, $.fn.datagrid.defaults.view, {
...
$.fn.datagrid.detailView = $.extend({},$.fn.datagrid.defaults.view, {
    ...
    expandRow: function (jq, index) {
        return jq.each(function () {
            ...
            if (expander.hasClass('datagrid-row-expand')) {
                ...
                if (opts.onExpandRow) {
                    if(!expander.data("__loaded__")){
                        expander.data("__loaded__",true);
